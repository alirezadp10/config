...
mkdir ~/config/temp;
cp ~/config/libs/bind9-zone-file ~/config/temp;
sed -i "s/LOCALHOST/$domain/g" ~/config/temp/bind9-zone-file;
sed -i "s/IP_ADDRESS/$ip_address/g" ~/config/temp/bind9-zone-file;
sudo mv ~/config/temp/bind9-zone-file "/etc/bind/db.$domain";
rm -r ~/config/temp;
